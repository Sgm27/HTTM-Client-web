"""
test_vintern.py - Minimal CLI (only --image), logic giữ nguyên như Colab.
...
def main():
    parser = argparse.ArgumentParser(description="Vintern-1B minimal CLI (only --image).")
    parser.add_argument("--image", type=str, required=True, help="Đường dẫn ảnh đầu vào.")
    args = parser.parse_args()

    # Hard-code y như Colab
